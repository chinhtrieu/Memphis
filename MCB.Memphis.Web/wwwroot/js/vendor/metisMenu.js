...
(function (global, factory) {
  ...
  var MetisMenu = function ($$$1) {
    ...
    var Default = {
      ...
      parentTrigger: 'li',
      subMenu: 'ul',
      closeTrigger: '.menu-expand-toggle'                                    // added by MCB
    };
    var Event = {
      SHOW: "show" + EVENT_KEY,
    ...
    function () {
      ...
      _proto.init = function init() {
        ...
        $$$1(this.element).find(conf.closeTrigger).on('click', function(e){
          var eTar = $$$1(this).closest('.menu-root');
          var List = eTar.children(conf.subMenu);
          List.addClass(conf.collapseInClass);

          eTar.children(conf.triggerElement).attr('aria-expanded', false);
          self.hide(List);
        });
      };
